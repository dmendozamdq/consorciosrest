...
use App\Services\EstudiantesService;
...
class EstudiantesController extends Controller
{
    ...
    function __construct(EstudiantesService $EstudiantesService)
    {
    ...
    {
        $informe = $this->EstudiantesService->index();
        ...
        /*$result = $this->EstudiantesService->index();
